...
export const Gradient = () => {
  return (
    <>
      <div
        className="relative z-1 h-6 mx-2.5 shadow-xl rounded-b-[1.25rem] lg:h-6 lg:mx-8"
        style={{
          background:
            "linear-gradient(90deg, #E28221 0%, #000432 25%, #E15F67 50%, #001671 75%, #003181 100%)",
        }}
      />
      <div
        className="relative z-1 h-6 mx-6 shadow-xl rounded-b-[1.25rem] lg:h-6 lg:mx-20"
        style={{
          background:
            "linear-gradient(90deg, #E28221 0%, #000432 25%, #E15F67 50%, #001671 75%, #003181 100%)",
          opacity: 0.7,
